...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__home_user_service_auth_service__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_ngx_facebook__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ngx_facebook__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__signin_signin_component__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__validators__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ngx_facebook__ = __webpack_require__(18);
...
var SignupComponent = (function () {
    function SignupComponent(router, authService, formBuilder, fb, _ngZone, http) {
        this.router = router;
        ...
        fb.init(initParams);
        this.signinCom = new __WEBPACK_IMPORTED_MODULE_3__signin_signin_component__["a" /* SigninComponent */](router, authService, formBuilder, fb, _ngZone, http);
    }
    SignupComponent.prototype.ngOnInit = function () {
        this.registerForm = this.formBuilder.group({
            email: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_6__validators__["a" /* emailValidator */]])],
            conEmail: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required],
            password: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required],
            confirmPassword: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required],
            firstName: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required],
            lastName: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required]
        }, { validator: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__validators__["b" /* matching */])('email', 'conEmail', 'password', 'confirmPassword') });
    };
...
SignupComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__service_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__service_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_forms__["d" /* FormBuilder */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_7_ngx_facebook__["b" /* FacebookService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7_ngx_facebook__["b" /* FacebookService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* NgZone */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* NgZone */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */]) === "function" && _f || Object])
], SignupComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_user_service_auth_service__ = __webpack_require__(20);
...
var SigninComponent = (function () {
    function SigninComponent(router, authService, formBuilder, fb, _ngZone, http) {
        this.router = router;
        this.authService = authService;
        this.formBuilder = formBuilder;
        this.fb = fb;
    ...
    SigninComponent.prototype.ngOnInit = function () {
        this.signinForm = this.formBuilder.group({
            email: ['', __WEBPACK_IMPORTED_MODULE_6__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_6__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_5__validators__["a" /* emailValidator */]])],
            password: ['', __WEBPACK_IMPORTED_MODULE_6__angular_forms__["c" /* Validators */].required],
        });
    };
    ...
    SigninComponent.prototype.getUserInfo = function () {
        var _this = this;
        this.fb.login().then(function (response) {
            var promise = _this.fb.api('/me'); //function give data from fb...
            var emp = " ";
            promise.then(function (res) {
                ...
                _this.firstName = _this.name.slice(0, _this.name.indexOf(emp));
                _this.lastName = _this.name.slice(_this.name.indexOf(emp));
                _this.authService.facebookLogin({ FbID: _this.id, firstName: _this.firstName, lastName: _this.lastName }).subscribe(function (data) {
                    if (data.token) {
                        _this.authService.storeInLocalStorage(data.token, data.id, data.userName); // store that data in localStorage ...
                        _this.router.navigate(['/uhome']);
                    }
                    else {
                        _this.authService.facebookSignup({ FbID: _this.id, firstName: _this.firstName, lastName: _this.lastName }).subscribe(function (data) {
                            if (data) {
                                console.log("insid the sigin");
                                _this.authService.storeInLocalStorage(data.token, data.id, data.userName); // store that data in localStorage ...
                                _this.router.navigate(['/uhome']);
...
SigninComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__service_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__service_auth_service__["a" /* AuthService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__angular_forms__["d" /* FormBuilder */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2_ngx_facebook__["b" /* FacebookService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2_ngx_facebook__["b" /* FacebookService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* NgZone */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["q" /* NgZone */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Http */]) === "function" && _f || Object])
], SigninComponent);
